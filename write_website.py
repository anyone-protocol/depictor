...
'ATORDAeuclive': Authority(
   ...
   or_port = 9201,
   dir_port = 9230,
   fingerprint = 'B2F74D89781BC5BD000576A09D6774DFD6D55D00',
   v3ident = '88F29CB5FE86A688E31990A3B20BD562D0C089E1',
 ),
'ATORDAuselive': Authority(
   ...
   or_port = 9201,
   dir_port = 9230,
   fingerprint = '7F52C639292FE397C0B39E4E24A4915095A8F63A',
   v3ident = '9572A9D4141A2AFC43C416E978D805E7C98B3B25',
 ),
'ATORDAuswlive': Authority(
   ...
   or_port = 9201,
   dir_port = 9230,
   fingerprint = 'CCDDD3E3C9094C32AA99197A9BE4291C85919AFB',
   v3ident = 'FFBFD3D2E92EEAA9162335FF8DF259CC62713784',
 ),
